    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center w-full px-4 py-8 mt-24">
          <div className="mx-16">
            <h1 className="text-[#053749] text-center font-[Montserrat] text-[32px] not-italic font-extrabold leading-[normal] mb-4">
            ...
            <p className="text-[12px] text-center mx-4 font-[Montserrat] text-black">
    ...
    >
      <div className="flex flex-row items-start justify-start w-full py-24">
        <div className="flex flex-col w-2/3 pr-20">
          ...
          <p className="text-[#000] font-[Montserrat] text-[30px] not-italic font-normal leading-[normal] mb-6 mt-4">
            {pageContent["body-home-section01-description"]}
          </p>
      ...
      <div className="w-full flex flex-row items-center justify-between mb-12">
        <div className="w-1/4 h-[100px]">
          <p className="flex w-[311px] h-[100px] flex-col justify-center text-[24px] not-italic font-extrabold leading-[37px] md:text-[18px] md:max-w-[100%] md:leading-[27px] xl:text-[24px] xl:max-w-[100%] xl:leading-[37px]">
        ...
        <div className="w-3/4 h-[100px] flex flex-row items-center justify-center gap-2 md:gap-2 lg:gap-6 xl:gap-12">
          ...
          <Image
            ...
            className="w-[50px] h-[50px] lg:w-[60px] lg:h-[60px] xl:w-[80px] xl:h-[80px]"
          />
          <p className="text-[#000] font-[Montserrat] text-[14px] not-italic font-extrabold leading-[29px]">
            {
              pageContent[
