...
export default function Section01() {
  return (
    <section className="flex w-10/12 h-screen mx-auto my-auto">
      <div className="flex flex-wrap place-content-center text-left sm:w-1/2 sm:h-5/6">
        <h1 className="sm:w-full font-chunkfive sm:text-5xl mb-2">
          Exchanging capacities,
        </h1>
        <h1 className="sm:w-full font-chunkfive sm:text-5xl mb-2">
          from wikimedians to wikimedians
        </h1>
