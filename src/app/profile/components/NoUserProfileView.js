...
import SimpleButton from "@/app/profile/edit/components/SimpleButton";
      ...
      <div className="w-full sm:w-8/12 mx-auto space-y-28">
        ...
        <section className="space-y-14 sm:space-y-14">
          <div className="flex flex-wrap w-full sm:flex-nowrap justify-center sm:justify-between gap-4 mb-6">
            <ButtonRedirectToPage to={"/"}
                                  style="w-fit h-fit tracking-widest text-sm px-4 sm:px-5 py-2 rounded-full bg-capx-secondary-grey hover:bg-capx-secondary-dark-grey text-[#F6F6F6] hover:text-capx-dark-bg">{pageContent["navbar-link-homepage"]}</ButtonRedirectToPage>
            <ButtonRedirectToPage to={"/profile"}
                                  style="w-fit h-fit tracking-widest text-sm px-4 sm:px-5 py-2 rounded-full bg-capx-secondary-purple hover:bg-capx-primary-green text-[#F6F6F6] hover:text-capx-dark-bg">{pageContent["navbar-link-profile"]}</ButtonRedirectToPage>
