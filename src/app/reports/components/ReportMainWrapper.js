...
const ReportMainWrapperWithErrorBoundary = withErrorBoundary(ReportMainWrapper);

function ReportMainWrapper(props) {
  let pageComponent;
...
export default ReportMainWrapperWithErrorBoundary;
