...
import ReportViewSkeleton from "@/app/reports/components/ReportViewSkeleton";
import ReportEditButton from "@/app/reports/components/ReportEditButton";

export default function ReportView({ darkMode, reportData, showEditButton, pageContent, language}) {
  if (reportData === undefined) {
    return (
        <ReportViewSkeleton darkMode={darkMode} />
    )
  }
  return (
