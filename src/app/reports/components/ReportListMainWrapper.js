...
import ReportListView from "@/app/reports/components/ReportListView";
...
export default function ReportListMainWrapper(props) {
  ...
  if (reportList !== undefined) {
    return (
        ...
        >
          <ReportListView darkMode={darkMode} reportList={reportList} pageContent={pageContent} language={language}/>
        </BaseWrapper>
    )
  }
}